...
const fetchAllTasks = async () => {
    ...
    return (
        <div className='task-manager-container d-flex flex-column align-items-center
        w-50 m-auto mt-5'>
            <h1 className='mb-4'>Task Manager App</h1>
            {/* Input and Search box */}
            <div className='task-input-section d-flex justify-content-between
